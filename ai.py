...
class Pipe:
    ...
    def collide(self, bird):  # check if bird collides with pipe
        # get masks
        ...
        # retreive boolean values (collide top/bottom)
...
def run(config_path):
    ...
    winner = p.run(main, 50)  # get winner from at most 50 generations
